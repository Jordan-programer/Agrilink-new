...
export default function AdminLogin() {
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden bg-gradient-to-b from-leaf-50 to-cream-50 py-16">
      <div
            ...
            <label className="block">
              ...
              <div className="relative mt-1.5">
                ...
                <input
                  ...
                  placeholder="admin@agrilink.store"
                  autoCapitalize="none"
