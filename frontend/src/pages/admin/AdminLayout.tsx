...
export default function AdminLayout() {
  ...
  const links = [
    { to: '/admin', label: t('adminLayout.navDashboard'), icon: LayoutDashboard, end: true },
    { to: '/admin/utilizadores', label: t('adminLayout.navUsers'), icon: Users },
    { to: '/admin/encomendas', label: t('adminLayout.navOrders'), icon: ShoppingBag },
    { to: '/admin/lavras', label: t('adminLayout.navFarms'), icon: Sprout },
  ]
