...
export default function GenericHome() {
  ...
  const stats = [
    ...
    { value: '-25%', label: t('home.statWaste') },
    { value: '24/7', label: t('home.statMonitoring') },
  ]

  const features = [
    { title: t('home.marketplaceTitle'), description: t('home.marketplaceDescription') },
    { title: t('home.iotTitle'), description: t('home.iotDescription') },
    { title: t('home.aiTitle'), description: t('home.aiDescription') },
  ]

  const impact = [
    t('home.impactIncome'),
    t('home.impactWaste'),
    t('home.impactProductivity'),
    t('home.impactFoodSecurity'),
  ]
  ...
  return (
    ...
    >
      ...
      <Text style={styles.heading}>
        {t('home.headingLine1')} <Text style={styles.headingAccent}>{t('home.headingAccent')}</Text>
      </Text>
      ...
      <Link href="/mercado" asChild>
        <Pressable style={styles.cta}>
          <Text style={styles.ctaText}>{t('home.exploreMarket')}</Text>
        </Pressable>
      </Link>
      ...
      <Text style={styles.sectionTitle}>{t('home.ecosystemTitle')}</Text>
      ...
      <Text style={styles.sectionTitle}>{t('home.impactTitle')}</Text>
      ...
      <View style={styles.finalCta}>
        ...
        <Link href="/mercado" asChild>
          <Pressable style={styles.finalCtaButton}>
            <Text style={styles.finalCtaButtonText}>{t('home.finalCtaButton')}</Text>
          </Pressable>
        </Link>
      </View>
    </ScrollView>
